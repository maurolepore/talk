...
tree <- read.nexus("mtnuc_GTR_Cyrt.tre")
#feed a list of tip you want to keep!
species<-c("C_Agam","C_Daun","C_Kaba","C_Timor","C_angularis","C_annandalei","C_aurensis","C_ayeyarwadyensis","C_batucolus","C_bichnganae","C_brevidactylus","C_cattienensis","C_chanhomeae","C_chrysopylos","C_condorensis","C_consobrinus","C_darmandvillei","C_dati","C_eisenmanae","C_elok","C_epiroticus","C_fasciolatus","C_feae","C_gansi","C_grismeri","C_guakanthanensis","C_gubernatoris","C_gubernatoris","C_hontreensis","C_interdigitalis","C_intermedius","C_irregularis","C_jarujini","C_jellesmae","C_khasiensis","C_kimberleyensis","C_lateralis","C_loriae","C_louisiadensis","C_macrotuberculatus","C_malayanus","C_marmoratus","C_novaeguineae","C_oldhami","C_pantiensis","C_paradoxus","C_petani","C_philippinicus","C_phuquocensis","C_psarops","C_pseudoquadrivirgatus","C_pubisulcus","C_pulchellus","C_quadrivirgatus","C_robustus","C_russelli","C_salomonensis","C_semenanjungensis","C_semicinctus","C_seribuatensis","C_sermowaiensis","C_slowinskii","C_smsp","C_sworderi","C_tigroides","C_tiomanensis","C_tuberculatus","C_yangbayensis","C_yoshii","C_zugi","Cyrtopodion_aravallensis","Cyrtopodion_elongatum","Cyrtopodion_himalayanum","Cyrtopodion_lawderanum","Cyrtopodion_mansarulus","Cyrtopodion_scabrum","Cyrtopodion_tibetanus","Geckoella_albofasciatus","Geckoella_collegalensis","Geckoella_deccanensis","Geckoella_jeyporensis","Geckoella_nebulosus","Geckoella_triedrus")
pruned.tree<-drop.tip(tree,tree$tip.label[-match(species, tree$tip.label)])
#output pruned tree
write.tree(pruned.tree, file="MyNewickTreefile.tre")
#########################################

setwd('~/Desktop/BGB_tutorial')
...
numstates_from_numareas(numareas=10, maxareas=3, include_null_range=F)
