* [Load the ggplot2 package](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#load-the-ggplot2-package)
* [Initialize a plot (`ggplot()`)](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#initialize-a-plot-ggplot)
* [Aesthetic mappings (`aes()`)](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#aesthetic-mappings-aes)
* [Adding components](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#adding-components)
* [Defaults and overrides](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#defaults-and-overrides)
* [Facets (`facet_wrap()` and `facet_grid()`)](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#facets-facet_wrap-and-facet_grid)
* [Changing cosmetic details](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#changing-cosmetic-details)
* [More](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#more)
* [Extending ggplot2](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#extending-ggplot2)
* [Decode](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#decode)
* [References](https://github.com/nmnh-r-users/R-Basics/wiki/Advanced-plotting#references)
